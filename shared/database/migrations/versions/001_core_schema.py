...
def upgrade():
    ...
    op.create_table(
        'agents',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('type', postgresql.ENUM(name='agenttype'), nullable=False),
        sa.Column('name', sa.String(255), nullable=False),
        sa.Column('version', sa.String(50), nullable=True),
        sa.Column('status', postgresql.ENUM(name='agentstatus'), nullable=False, server_default='starting'),
    ...
    op.create_table(
        ...
        sa.Column('severity', postgresql.ENUM(name='eventseverity'), nullable=False, server_default='info'),
    ...
    op.create_table(
        ...
        sa.Column('priority', postgresql.ENUM(name='recommendationpriority'), nullable=False, server_default='medium'),
        sa.Column('status', postgresql.ENUM(name='recommendationstatus'), nullable=False, server_default='pending'),
        sa.Column('data', postgresql.JSONB, nullable=False, server_default='{}'),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM(name='approvalstatus'), nullable=False, server_default='pending'),
    ...
    op.create_table(
        ...
        sa.Column('customer_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('agent_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('status', postgresql.ENUM(name='optimizationstatus'), nullable=False, server_default='queued'),
